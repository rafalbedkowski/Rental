    ...
    public partial class Initialize : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.Users", t => t.AppUser_UserId, cascadeDelete: false)
                .ForeignKey("dbo.Users", t => t.Customer_UserId, cascadeDelete: false)
                .ForeignKey("dbo.Tools", t => t.Tool_ToolId, cascadeDelete: false)
